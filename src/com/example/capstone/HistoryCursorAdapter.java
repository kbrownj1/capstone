...
public class HistoryCursorAdapter extends CursorAdapter {
    ...
    // copy of cursor that is returned by method query().
    private static Cursor historyCursor;
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        TextView author = (TextView) view.findViewById(R.id.chat_message_Author);
        String src = cursor.getString(cursor.getColumnIndex("src"));
        if (src.startsWith(this.from)) {
        ...
        // change the emergency message to red color
    ...
    public static Cursor query(Context context, String accountJid, String jid) {
        ...
        // Make sure previous cursor is closed.
        if (historyCursor != null) {
        	historyCursor.close();
        }
        
        historyCursor = database.query(
            "msg",
        ...
        historyCursor.setNotificationUri(context.getContentResolver(), builder.build());
